...
<template>
<section class="text-gray-600 body-font bg-blue-100 py-10 ">
    <div class="container flex flex-col md:flex-row lg:max-w-5xl w-full px-5 py-12 md:py-24 mx-auto section"
        ...
        <div class="md:w-1/3 w-full">
            ...
            <p class="leading-relaxed text-xl text-gray-900">
                ...
                You can also email us. Click here to reveal email address
                   <a href="boyapatisaikeerthana@gamil.com" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">https://mail.google.com/mail/u/0/#inbox</a>
    
            </p>
            <p class="leading-relaxed text-xl text-gray-900 mt-8">
                We use gmail to protect your email address from spam.
            </p>
        ...
        <div class="md:w-2/3 w-full mt-10 md:mt-0 md:pl-28">
            ...
            <form action="send-contact.php" method="post" id="submit-contact-form">
                ...
                <div class="p-2 w-full">
                    <button type="submit"
                        class="flex text-white bg-blue-500 border-0 py-4 px-6 focus:outline-none hover:bg-blue-900 rounded text-xl font-bold shadow-lg mx-0 flex-col text-center g-recaptcha">
                        Send Message ✉
                    </button>
                </div>
            </form>
